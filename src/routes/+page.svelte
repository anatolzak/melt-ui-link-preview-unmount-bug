...
<button on:click={() => (mounted = !mounted)}>mount/unmount</button>
...
{#if mounted}
	...
	{#if $open}
		<div
			...
			class="force-dark z-10 rounded-md bg-blue-100 shadow-sm"
		>
			<div class="w-[300px] rounded-md p-5 shadow-sm">
...
<style lang="postcss">
	.trigger {
		...
		@apply rounded-full bg-white text-sm font-medium;
